...
class GeminiProvider(LLMProvider):
    ...
    def __init__(self):
        ...
        if api_key is None:
            raise ValueError("GOOGLE_API_KEY is not set in the environment variables. Make sure to copy the .env.template file to .env and fill in the GOOGLE_API_KEY.")
